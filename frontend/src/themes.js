export const CATEGORIES = [
  ...
  { id: "tarjeta_regalo", name: "Tarjeta de regalo", emoji: "🎁" },
  { id: "baby_shower", name: "Baby Shower", emoji: "🍼" },
  { id: "grado", name: "Grado", emoji: "🎓" },
];
...
export const CATEGORY_FIELDS = {
  ...
  tarjeta_regalo: {
    nameLabel: "¿Para quién es la tarjeta? *", namePlaceholder: "Valentina", fallbackName: "Tu persona especial", showAge: false, showSubtitle: true,
    subtitleLabel: "Mensaje corto o detalle especial (opcional)", subtitlePlaceholder: "Ej: Feliz aniversario, mi amor",
    dressCodeLabel: "Etiqueta (opcional)", dressCodePlaceholder: "Ej: Casual, solo trae tu mejor sonrisa",
  },
  baby_shower: {
    nameLabel: "Nombre del bebé o de los papás *", namePlaceholder: "Baby Martínez", fallbackName: "El bebé en camino", showAge: false, showSubtitle: true,
    subtitleLabel: "Nota especial (opcional)", subtitlePlaceholder: "Ej: Aún no sabemos si es niño o niña",
    dressCodeLabel: "Código de vestimenta (opcional)", dressCodePlaceholder: "Ej: Casual, tonos pasteles",
  },
  grado: {
    nameLabel: "Nombre del graduado o graduada *", namePlaceholder: "Andrea Gómez", fallbackName: "El graduado", showAge: false, showSubtitle: true,
    subtitleLabel: "Carrera o institución (opcional)", subtitlePlaceholder: "Ing. Industrial · Universidad Nacional",
    dressCodeLabel: "Código de vestimenta (opcional)", dressCodePlaceholder: "Ej: Formal",
  },
};
...
export const THEMES = {
  ...
  aniversario: {
    ...
    font: "'Cormorant Garamond', serif",
    fontScale: 1.15,
    colors: { bg: "#FFF6F3", surface: "#FFFFFF", primary: "#B4586B", text: "#3D2430", accent: "#E8A0AE", soft: "#F6D9DE" },
    image: "https://images.unsplash.com/photo-1494955870715-979ca4f13bf0?crop=entropy&cs=srgb&fm=jpg&q=85&w=800",
    decorations: ["💕", "🌹", "✨", "💌", "🥂", "🕯️"],
    copy: {
      badge: (inv) => `${inv.child_name}`,
      title: (inv) => `Para ${inv.child_name}, con todo mi amor 💕`,
      subtitle: (inv) => inv.event_subtitle || "Una fecha para recordar por qué te amo",
      countdown: "💕 Nuestro aniversario es en",
      details: "🥂 Detalles de nuestra celebración 🥂",
      arrive: "🗺️ Cómo llegar",
      rsvpTitle: "💌 Déjale saber que la recibiste",
      rsvpSubtitle: "Cuéntale cómo te sentiste al recibir esta sorpresa",
      confirm: "💕 ENVIAR RESPUESTA",
      successTitle: "💕 ¡MENSAJE ENVIADO! 💕",
      successExtra: "🥂✨",
      punctual: "El amor no tiene horario, pero aquí tienes uno igual",
      msgLabel: () => `Tu mensaje de vuelta (opcional)`,
    },
  },
  amor_amistad: {
    id: "amor_amistad",
    ...
    font: "'Dancing Script', cursive",
    fontScale: 1.2,
    colors: { bg: "#FFF8F5", surface: "#FFFFFF", primary: "#C6524A", text: "#3A241F", accent: "#F2896F", soft: "#FBDCCF" },
    image: "https://images.unsplash.com/photo-1494955870715-979ca4f13bf0?crop=entropy&cs=srgb&fm=jpg&q=85&w=800",
    decorations: ["🎁", "💕", "💌", "🌸", "✨", "🧸"],
    copy: {
      badge: (inv) => `${inv.child_name}`,
      title: (inv) => `¡Una sorpresa para ${inv.child_name}! 🎁`,
      subtitle: (inv) => inv.event_subtitle || "Porque la amistad (y el amor) también se celebran",
      countdown: "🎁 Tu sorpresa llega en",
      details: "💌 Detalles de la sorpresa 💌",
      arrive: "🗺️ Cómo llegar",
      rsvpTitle: "💌 Confírmale que la recibiste",
      rsvpSubtitle: "Cuéntale qué te pareció este detalle",
      confirm: "🎉 ENVIAR RESPUESTA",
      successTitle: "🎁 ¡MENSAJE ENVIADO! 🎁",
      successExtra: "💕✨",
      punctual: "Ábrela con calma, este detalle es para disfrutarlo",
      msgLabel: () => `Tu mensaje de vuelta (opcional)`,
    },
  },
  baby_shower: {
    ...
    fontScale: 1,
    colors: { bg: "#FFFDF7", surface: "#FFFFFF", primary: "#C9A87C", text: "#4A3F30", accent: "#8FBFA8", soft: "#F0E6D2" },
    image: "https://images.unsplash.com/photo-1580301762395-21ce84d00bc6?crop=entropy&cs=srgb&fm=jpg&q=85&w=800",
    decorations: ["🍼", "👶", "🧸", "⭐", "🎀", "☁️"],
    copy: {
      badge: (inv) => `Baby Shower de ${inv.child_name}`,
      title: (inv) => `¡Vamos a conocer a ${inv.child_name}! 👶`,
      subtitle: (inv) => inv.event_subtitle || "Acompáñanos a celebrar la llegada de este angelito",
      countdown: "👶 Nos vemos en",
      details: "🍼 Detalles de la celebración 🍼",
      arrive: "🗺️ Cómo llegar",
      rsvpTitle: "🎀 Confirma tu asistencia",
      rsvpSubtitle: "Ayúdanos a organizar todo para este día tan especial",
      confirm: "🧸 CONFIRMAR ASISTENCIA",
      successTitle: "🍼 ¡GRACIAS POR CONFIRMAR! 🍼",
      successExtra: "🎀✨",
      punctual: "Te esperamos puntual para no perderte ningún juego",
      msgLabel: () => `Mensaje para los futuros papás (opcional)`,
    },
  },
  grado: {
    id: "grado",
    ...
    fontScale: 0.95,
    colors: { bg: "#0E1B2E", surface: "#16273F", primary: "#C9A227", text: "#F5F1E6", accent: "#5B8DBF", soft: "#E8D9A0" },
    image: "https://images.unsplash.com/photo-1758550445758-165aeab5b26e?crop=entropy&cs=srgb&fm=jpg&q=85&w=800",
    decorations: ["🎓", "📜", "🎉", "✨", "🏆", "👏"],
    copy: {
      badge: (inv) => `${inv.child_name} · Grado`,
      title: (inv) => `¡${inv.child_name} se gradúa! 🎓`,
      subtitle: (inv) => inv.event_subtitle || "Ven a celebrar este logro con nosotros",
      countdown: "🎓 La ceremonia es en",
      details: "📜 Detalles de la ceremonia 📜",
      arrive: "🗺️ Cómo llegar",
      rsvpTitle: "🎉 Confirma tu asistencia",
      rsvpSubtitle: "Nos encantaría que nos acompañes en este logro",
      confirm: "🏆 CONFIRMAR ASISTENCIA",
      successTitle: "🎓 ¡GRACIAS POR CONFIRMAR! 🎓",
      successExtra: "🎉👏",
      punctual: "Llega con tiempo, la ceremonia inicia puntual",
      msgLabel: (inv) => `Mensaje para ${inv.child_name} (opcional)`,
    },
  },
};
...
export const ELEGANT_HERO_CATEGORIES = new Set([
  ...
  "partido", "parche", "reto_deportivo", "tarjeta_regalo", "baby_shower", "grado",
]);
